...
from .app_bicone import BICONE_ID,BICONEApp
...
ALL_SAV_MECHANISM_IDs = [STRICT_URPF_ID, LOOSE_URPF_ID, RPDP_ID, EFP_URPF_B_ROA_ASPA_ID, EFP_URPF_A_ROA_ASPA_ID,
                         EFP_URPF_A_ASPA_ID, EFP_URPF_B_ASPA_ID, EFP_URPF_B_ROA_ID, EFP_URPF_A_ROA_ID, EFP_URPF_A_ID, EFP_URPF_B_ID,BICONE_ID]
...
def sav_app_init(agent, logger):
    ...
    try:
        ...
        ret[BICONE_ID] = BICONEApp(agent, BICONE_ID, logger)
